    ...
    >
      <div className="row justify-content-center">
        <div className="col-12 col-md-8">
          ...
          <p style={textStyle}>
            CineNiche is committed to protecting your personal information as
            you explore and stream unique films on our platform.
          </p>
          <p style={textStyle}>
          ...
          <ul style={{ listStyleType: 'none', paddingLeft: 0 }}>
            <li>
              <a
                href="/CineNichePrivacyPolicy.pdf"
                style= {linkStyle}
                download="CineNichePrivacyPolicy.pdf"
              >
