            ...
            <div className="card-body">
              {user ? (
                <>
                  ...
                  <div>
                    <button className="btn btn-primary disabled me-2">
                      {user.role}
                    </button>
                ...
                {!loading &&
                  ...
                  (users.length > 0 ? (
                    <div>
                      <div className="my-2">
                        <div>
                          ...
                          <div className="dropdown d-inline mx-2">
                            ...
                            <DropdownList
                              currentValue={filters.pageSize}
                              options={[6, 8, 12, 16, 20, 24]}
                              onChange={(value) =>
                      ...
                      <div
                        className={`row row-cols-1 row-cols-md-2 ${filters.pageSize >= 12 ? 'row-cols-lg-3' : 'row-cols-lg-2'} g-2`}
                      >
                        {users.map((user) => (
                      ...
                      <Pagination
                        ...
                        onPageChange={(page: any) =>
                          handleFilterChange({ pageNum: page }, false)
                        }
                      />
                    </div>
                  ) : (
