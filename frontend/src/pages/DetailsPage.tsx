            ...
            <>
              ...
              <div className="genre-tags">
                {movie?.genres?.map((genre, index) => (
                  <span key={index} className="genre-tag">{genre.genreName}</span>
                ))}
              </div>
              ...
              <div className="movie-actions">
                ...
                <button className="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#ratingModal">
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content bg-dark text-white">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" onClick={() => console.log(`Submitted rating: ${selectedRating}`)}>
                Submit
              </button>
            </div>
          </div>
